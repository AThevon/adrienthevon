      ...
      {!isExiting ? (
        ...
        >
          ...
          <div className="absolute bottom-20 left-20 right-20">
            <div className="flex justify-between mb-4 font-mono text-sm text-muted">
          ...
          <div className="absolute top-8 left-8 font-mono text-xs text-muted">
            <div>001</div>
            <div className="mt-1">PORTFOLIO—2025</div>
          </div>

          <div className="absolute top-8 right-8 font-mono text-xs text-muted text-right">
            <div>CREATIVE</div>
